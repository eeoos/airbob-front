...
> Baseline state: U4 commit `f5222d5`, followed by U6 and the current U5 cutover.
> Current cutover state: U6 app Router/shells and the U5 app session boundary active.
...
| Slice | Current/old owner | Target/new owner | Current active owner after U5/U6 | Read compatibility | Rollback reader/artifact | Removal condition |
| --- | --- | --- | --- | --- | --- | --- |
...
| Capability | Current/old owner and writer | Target/new owner | Current active owner after U5/U6 | Allowed read compatibility | Rollback/removal condition |
| --- | --- | --- | --- | --- | --- |
