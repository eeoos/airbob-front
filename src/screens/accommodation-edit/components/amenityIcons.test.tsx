...
const editorAmenityGeometry = {
  ...
  DRYER:
    "rect(height=18,rx=2,width=18,x=3,y=3)|circle(cx=12,cy=12,r=4)",
  PARKING:
  ...
  SHAMPOO:
    "rect(height=20,rx=2,width=8,x=8,y=2)|path(d=M8 6h8M8 10h8)",
  BED_LINENS:
    "rect(height=12,rx=2,width=18,x=3,y=8)|path(d=M3 12h18M3 16h18)",
  EXTRA_PILLOWS:
    "rect(height=12,rx=2,width=16,x=4,y=6)|path(d=M8 10h8M8 14h8)",
  ...
  POOL:
    "path(d=M3 12h18M3 16h18M3 8h18)|circle(cx=6,cy=12,r=2)|circle(cx=18,cy=12,r=2)",
  HOT_TUB:
    "circle(cx=12,cy=12,r=10)|circle(cx=12,cy=12,r=6)|circle(cx=12,cy=12,r=2)",
  GYM:
    "rect(height=18,rx=2,width=18,x=3,y=3)|path(d=M12 3v18M3 12h18)|circle(cx=8,cy=8,r=1)|circle(cx=16,cy=16,r=1)",
  SMOKE_ALARM:
