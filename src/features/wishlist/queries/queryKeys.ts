...
export const wishlistReadQueryKeys = {
  ...
  lists: (scope: AuthenticatedSessionScope, accommodationId: number | null) =>
    withSessionScopeKey(scope, [...root, "lists", accommodationId] as const),
  detail: (scope: AuthenticatedSessionScope, wishlistId: number | null) =>
    withSessionScopeKey(scope, [...root, "detail", wishlistId] as const),
