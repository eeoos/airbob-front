...
import * as searchBarSearchModule from "./useSearchBarSearch";
...
describe("useSearchBarState search boundary", () => {
  beforeEach(() => {
  ...
  it("delegates search submission to a dedicated hook", async () => {
    const searchHook = jest.spyOn(
    ...
    await waitFor(() => expect(searchHook).toHaveBeenCalled());
  });
});
